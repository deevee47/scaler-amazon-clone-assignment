    ...
    <header className="bg-transparent sticky top-0 z-50">
      <div className="w-full h-14 bg-[#131921] text-lightText sticky top-0 z-50">
        <div className="h-full w-full mx-auto inline-flex items-center md:justify-between gap-1 px-3">
          ...
          <Link
            href={"/orders"}
            className="hidden md:flex text-sm text-white flex-col justify-center leading-none px-2 border border-transparent hover:border-white cursor-pointer duration-300 h-[70%]"
          >
